...
const generateChangelog = async function(comparedBranches, client, ownerRepo) {
    const changelog = {
        enhancement: [],
        bug        : []
    };
...
module.exports = async function exports(client, tags) {
    ...
    try {
        ...
        const changelog = await generateChangelog.call(this, comparedCommits, client, ownerRepo);
